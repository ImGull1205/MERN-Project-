    ...
    <>
      <div className="flex gap-2">
        <input value={photoLink}
              ...
              className="text-black p-2 border rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-app_blue"/>
        <button onClick={addPhotoByLink} className="bg-app_blue text-white px-4 rounded-2xl hover:bg-blue-700 transition-colors">Add&nbsp;photo</button>
      </div>
